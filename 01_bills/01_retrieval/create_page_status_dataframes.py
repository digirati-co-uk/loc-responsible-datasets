...
from utils.status import (
    congress_page_status_dataframes,
)


def create_page_status_dataframes(
    source_location: Annotated[
        str,
        typer.Option(help="Location containing source pages created by other scripts."),
...
if __name__ == "__main__":
    typer.run(create_page_status_dataframes)
